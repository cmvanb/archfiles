...
local colors = {
    ...
    theme_2_fg  = Colors.hash('ds_blue_9'),
    theme_3_fg  = Colors.hash('ds_blue_8'),
    theme_1_bg  = Colors.hash('ds_blue_5'),
    theme_2_bg  = Colors.hash('ds_blue_4'),
    theme_3_bg  = Colors.hash('ds_blue_3'),
    normal_fg   = Colors.hash('l4_blue'),
    normal_bg   = Colors.hash('ds_blue_5'),
