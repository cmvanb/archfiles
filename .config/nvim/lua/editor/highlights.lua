...
hi('Normal',               'secondary_13', 'primary_0',    'NONE',    'ansi_cyan',       'ansi_black',      'NONE')
...
hi('CursorLineNr',         'text_12',      'primary_1',    'NONE',    'ansi_cyan',       'ansi_black',      'NONE')
hi('LineNr',               'text_8',       'NONE',         'NONE',    'ansi_brblack',    'NONE',            'NONE')
hi('SignColumn',           'text_8',       'primary_0',    'NONE',    'ansi_white',      'ansi_black',      'NONE')
