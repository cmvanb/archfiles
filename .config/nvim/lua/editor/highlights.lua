...
hi('LualineDiagError',       'red',        'ds_blue_4',  'bold',            'ansi_red',        'NONE',  'NONE')
hi('LualineDiagWarn',        'yellow',     'ds_blue_4',  'bold',            'ansi_yellow',     'NONE',  'NONE')
hi('LualineDiagInfo',        'white',      'ds_blue_4',  'bold',            'ansi_white',      'NONE',  'NONE')
hi('LualineDiagHint',        'l2_purple',  'ds_blue_4',  'bold',            'ansi_magenta',    'NONE',  'NONE')
