...
hi('Visual',               'black',        'secondary_12', 'NONE',    'ansi_black',      'ansi_brcyan',     'NONE')
...
hi('FloatMenuNormal',     'text_2',      'primary_0',  'NONE',    'ansi_cyan',      'ansi_blue',   'NONE')
...
hi('Comment',     'secondary_5',  'NONE',        'italic',          'ansi_brblack',    'NONE',  'NONE')
