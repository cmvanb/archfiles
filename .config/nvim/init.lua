...
hi('Normal       ', '6    ', '0    ', 'NONE           ', colors.hash('ds_cyan_6')  , colors.hash('editor_bg')   , 'NONE           ')
hi('NonText      ', '4    ', 'NONE ', 'NONE           ', colors.hash('debug')      , 'NONE '                    , 'NONE           ')
hi('Cursor       ', '0    ', '7    ', 'NONE           ', colors.hash('black')      , colors.hash('white')       , 'NONE           ')
hi('CursorLine   ', 'NONE ', '0    ', 'NONE           ', 'NONE '                   , colors.hash('ds_blue_1')   , 'NONE           ')
hi('CursorLineNr ', '7    ', '0    ', 'NONE           ', colors.hash('ds_cyan_5')  , colors.hash('ds_blue_1')   , 'NONE           ')
hi('LineNr       ', '8    ', 'NONE ', 'NONE           ', colors.hash('ds_cyan_3')  , 'NONE '                    , 'NONE           ')
...
hi('StatusLineNC ', '8    ', '0    ', 'bold           ', colors.hash('ds_cyan_3')  , colors.hash('ds_cyan_0')   , 'NONE           ')
...
hi('MsgArea      ', '7    ', '4    ', 'bold           ', colors.hash('ds_cyan_6')  , colors.hash('editor_bg')   , 'NONE           ')
...
hi('Comment         ', '8    ', 'NONE ', 'NONE           ', colors.hash('ds_cyan_3')  , 'NONE ', 'italic         ')
...
hi('Function        ', '13   ', 'NONE ', 'bold           ', colors.hash('ds_cyan_8')  , 'NONE ', 'bold           ')
